...
function App() {
  ...
  const merge = (sortedLeftArray: number[] | undefined, sortedRightArray: number[] | undefined) => {
    console.log('hoge', sortedLeftArray, sortedRightArray)
    ...
    while (leftIndex < sortedLeftArray.length && rightIndex < sortedRightArray.length) {
      console.log(sortedLeftArray.length, sortedRightArray.length)
    ...
    console.log(sortedLeftArray.slice(leftIndex), sortedRightArray.slice(rightIndex))
